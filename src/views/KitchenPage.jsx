              ...
              <div className="mt-4 flex flex-col divide-y">
                {
                  items.map((item, index)=>{
                    ...
                    const modifiersItems = JSON.parse(modifiers)?.length > 0 ? JSON.parse(modifiers)?.map((a)=>a.title)?.join(", ") : null;
                    return  <div key={index} className="flex items-center gap-2 py-2">
                      ...
                      <div className="flex-1">
                        ...
                        {modifiersItems && <p className="text-sm text-gray-700">Modifiers: {modifiersItems}</p>}
