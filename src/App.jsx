...
import AddsetmodifierPage from "./views/SettingsViews/AddsetmodifierPage";
import EditsetmodifierPage from "./views/SettingsViews/EditsetmodifierPage";
...
import SetModifiersPage from "./views/SettingsViews/SetModifiersPage";
import ModifiersPage from "./views/SettingsViews/ModifiersPage";
...
import PaxPaymentSettings from "./views/SettingsViews/PaxPaymentSettings";
        ...
        <Routes>
          ...
          <Route
            ...
            <Route
              ...
              {
                <Route
                  path="add-modifier-set"
                  element = {<AddsetmodifierPage/>}
                />
              }
              {
                <Route
                  path="edit-modifier-set/:id"
                  element = {<EditsetmodifierPage/>}
                />
              }

              {<Route
                path="modifier-set"
                element={<SetModifiersPage />}
              />}

              {<Route
                path="tables"
                element={<TablesSettingsPage />}
              />}
            ...
            >
              ...
              <Route path="pax-payment-settings" element={<PaxPaymentSettings />} />
            </Route>
          </Route>
          {/* app routes */}
